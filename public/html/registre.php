            ...
            <div class="card shadow-sm mt-5" style="width: 18rem;">
                ...
                <div class="card-body">
                    <form>
                    	...
                    	<button class="btn btn-primary btn-block rounded mt-4" type="button" onClick="comprovaContrasenya()"><?php echo $lang[$idioma]["submit"]?> &nbsp;&nbsp;<i class="fas fa-angle-right"></i></button>
                    </form>
                </div>
            </div>
        </div>
